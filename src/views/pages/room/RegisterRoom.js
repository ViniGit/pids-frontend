...
const RegisterRoom = () => {
  ...
  async function handleSubmitt(values) {
    ...
    await api.post('rooms', room, config)
      .then(response => {
      ...
      .catch(error => {
        toast.error("Ocorreu um erro ao cadastrar Sala.", {
          autoClose: 3000,
        });
      })
  }
                  ...
                  <div className="pl-lg-4">
                    <Row>
                      ...
                      <Col lg="9">
                        ...
                        {touched.type && errors.type ? <p className="mt-2 text-warning">{errors.type}</p> : null}
